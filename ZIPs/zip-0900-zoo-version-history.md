...
(LPs) and to the  adoption record. It exists so
...
|---|---|---|---|---|
| **1.0** | BSC era (original) | **2021-10-31** | [`zoo-2021-original-whitepaper`](../../papers/zoo-2021-original-whitepaper) | Original Antje Worring vision; coined the term "NFT "; wildlife conservation NFTs as productive collateral. |
...
| **Zoo DEX** | Native securities +  | **2026-04-20** | [`zoo-dex-launch-2026-04-20`](../../papers/zoo-dex-launch-2026-04-20) | $113T digital-securities market access via tokenised equities, fixed income, RWA, and derivatives.  adoption ( launched it 2026-04-01; Lux/Hanzo/Zoo/Pars adopted it 2026-04-20). Robinhood-style retail UX with sub-1.1s T+0 settlement. |
...
paper introduced the term "NFT " --- a system in
...
NFT  commitments still ran on classical cryptography
...
- **Consensus signatures** moved to triple cert ($BLS_{12-381}$ +
  Corona Ring-LWE + ML-DSA-65) inherited from Lux Quasar 3.0
  (LP-020).
- **Governance keys** migrated to threshold ML-DSA-65 + Corona.
...
- **Triple-consensus signature verification** ($BLS_{12-381}$
  aggregate + Corona threshold + ML-DSA-65 identity) as fused GPU
...
#### Zoo DEX — Native securities +  (2026-04-20)
...
- ** integration.**  launched the
  formal  on 2026-04-01 with a soundness proof
...
- **LP-020** --- Quasar Consensus 3.0 (triple cert: BLS + Corona + ML-DSA).
- **LP-063** --- Z-Chain Zero-Knowledge Rollup and ZKP Registry.
- **LP-070** --- ML-DSA-65 Identity Proof Lane.
- **LP-073** --- Corona Ring-LWE Threshold Signature.
...
The  adoption chronology referenced by the Zoo DEX
paper:

| Date | Actor | Action |
|---|---|---|
| **2026-04-01** |  | Formal launch of the  with soundness proof. |
| **2026-04-20** | Lux | Adopts the  on Lux C-Chain and Lux D-Chain. |
| **2026-04-20** | Hanzo | Adopts the  on Hanzo AI Chain marketplace flow. |
| **2026-04-20** | Zoo | Adopts the  on Zoo D-Chain via the Liquidity precompile. |
