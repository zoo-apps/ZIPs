...
| **Zoo DEX** | Native securities + Liquidity Protocol | **2026-04-20** | [`zoo-dex-launch-2026-04-20`](../../papers/zoo-dex-launch-2026-04-20) | $113T digital-securities market access via tokenised equities, fixed income, RWA, and derivatives. Liquidity Protocol adoption (the external partner launched it 2026-04-01; Lux/Hanzo/Zoo/Pars adopted it 2026-04-20). Robinhood-style retail UX with sub-1.1s T+0 settlement. |
...
- **Liquidity Protocol integration.** the external partner launched the
...
| Date | Actor | Action |
|---|---|---|
| **2026-04-01** | the external partner | Formal launch of the Liquidity Protocol with soundness proof. |
...
the external partner formal proof of the protocol itself is at
`a partner-maintained repository`.
