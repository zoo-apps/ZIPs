...
Zoo source trees MUST NOT contain references to Liquidity (`/*` repos, regulated US securities ATS). Zero substring matches for ``, `@/*` in Zoo source. The inverse rule is codified in Liquidity's CLAUDE.md.
