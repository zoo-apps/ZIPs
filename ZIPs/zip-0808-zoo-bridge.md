...
tags: [bridge, b-chain, m-chain, mpc, threshold-signing, corona, asset-migration]
...
4. **Post-quantum security.** Corona threshold layer (LP-073) ensures no classical-key compromise can forge a release.
...
Zoo L1 ─┐
        ...
        └──← M-Chain (MVM) threshold sign ceremony
                ...
                └── Corona (LP-073) post-quantum threshold proof
```
...
- 2-of-3 threshold ceremony with Corona (LP-073) post-quantum proof: forgery requires both classical compromise and post-quantum compromise.
...
- LP-073 — Corona Threshold Proofs
