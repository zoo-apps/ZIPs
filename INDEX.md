...
| 20 | NFT  | ZIP-0206 | ZIP-0106 | `zoo-nft-liquidity-protocol` (2021) |
...
| `zoo-nft-liquidity-protocol` | NFT  (sec. 20), Collateral-Backed NFTs (sec. 10) | ZIP-0206, ZIP-0106 |
...
- ZIP-0106 traces from section 20 (NFT ). Follow-on: `zoo-nft-liquidity-protocol` (2021), `zoo-dex` (2024).
...
- ZIP-0206 traces from sections 10 (Collateral-Backed NFTs) and 20 (NFT ). Follow-on: `zoo-nft-liquidity-protocol` (2021).
...
LP-020 (Quasar 3.0), LP-070 (ML-DSA), LP-073 (Corona), LP-075 (BLS),
...
|-----|--------------|-------|
| ZIP-0103, ZIP-0206 | NFT  (2021 trade name; collateral-backed NFT lending, sustainability tax flow, marketplace settlement) | `~/work/zoo/proofs/zoo-nft-liquidity-protocol-soundness.tex` |
...
| ZIP-0103, ZIP-0206 (composition) | 2026-04-20 adoption of 's  with formal trade-name disambiguation | `~/work/zoo/proofs/zoo-adopts-liquidity-protocol.tex` |

The 2021 Zoo "NFT " (Worring & Kelling, October 2021)
predates 's "" (, 2026-04-01)
